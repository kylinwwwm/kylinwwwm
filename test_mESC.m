...
% data_all = load('mESC_total_data.mat');


data_all = csvread('data/Mbln2.csv');

save_folder  = fullfile(pwd,'results1/results_mESC');
...
load('E:\code\1_test\results1\results_mESC\result_gene_1')